...
export default function GitHubChapterClientPage({
  ...
  const prevChapter =
    chapterIndex > 0 ? githubChapters[chapterIndex - 1] : null;
  const nextChapter =
    chapterIndex < githubChapters.length - 1
      ? githubChapters[chapterIndex + 1]
      : null;
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6">
        <Link
          href="/github"
          className="inline-flex items-center text-sm text-muted-foreground hover:text-[#24292F] dark:hover:text-white transition-colors"
        >
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex justify-between items-center">
            {prevChapter ? (
              <Link href={`/github/${prevChapter.id}`}>
            ...
            {nextChapter ? (
              <Link href={`/github/${nextChapter.id}`}>
                <Button variant="outline" className="gap-2">
                  <span className="hidden sm:inline">
                    {nextChapter.title}
                  </span>
