...
import { springSecurityQuizQuestions } from "@/data/spring-security-quiz";
...
export default function QuizClientPage() {
  const questions = useMemo(() => {
    const shuffled = [...springSecurityQuizQuestions].sort(() => Math.random() - 0.5);
