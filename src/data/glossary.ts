...
export const glossaryCategories = [
  ...
  { id: "framework", name: "フレームワーク", color: "var(--color-dads-amber)" },
  { id: "devops", name: "DevOps・インフラ", color: "var(--color-dads-rose)" },
  { id: "database", name: "データベース", color: "var(--color-dads-indigo)" },
] as const;
...
var stream = list.stream();          // Stream<String>`,
  ...
  // ===== フレームワーク =====
  {
    ...
    reading: "スプリングブート",
    category: "framework",
    description: "Spring Frameworkを基盤とした自動設定フレームワーク。組み込みサーバー、スターター依存関係、アクチュエータにより、最小限の設定で本番品質のアプリケーションを構築できる。",
    related: ["Spring Framework", "DI", "Auto Configuration"],
  },
  {
    term: "DI（依存性注入）",
    reading: "ディーアイ",
    category: "framework",
    description: "Dependency Injectionの略。オブジェクトの依存関係を外部から注入するデザインパターン。Springでは@Autowiredやコンストラクタインジェクションで実現する。テスタビリティと疎結合性を向上させる。",
    related: ["Spring Boot", "IoC", "コンストラクタインジェクション"],
  },
  {
    term: "Spring Security",
    reading: "スプリングセキュリティ",
    category: "framework",
    description: "Spring Frameworkの認証・認可フレームワーク。SecurityFilterChainでHTTPセキュリティを設定し、フォーム認証、OAuth2、JWT、RBAC、CORS/CSRF保護などを提供する。",
    related: ["JWT", "OAuth2", "RBAC"],
  },
  {
    term: "JWT",
    reading: "ジェイダブリューティー",
    category: "framework",
    description: "JSON Web Tokenの略。ヘッダー、ペイロード、署名の3部分からなるトークンベースの認証方式。ステートレスで、マイクロサービス間の認証に適している。",
    related: ["Spring Security", "OAuth2", "Bearer Token"],
  },
  {
    term: "OAuth2",
    reading: "オーオース2",
    category: "framework",
    description: "認可のためのオープンスタンダード。Google、GitHub等のサードパーティ認証を安全に委譲する。Authorization Code、Client Credentials等のグラントタイプがある。",
    related: ["JWT", "Spring Security", "OpenID Connect"],
  },
  {
    term: "JPA",
    reading: "ジェイピーエー",
    category: "framework",
    description: "Java Persistence APIの略。JavaオブジェクトとリレーショナルDBのマッピング（ORM）の標準仕様。Hibernateが最も広く使われる実装。@Entity、@Table、JPQL等で操作する。",
    related: ["Hibernate", "ORM", "JPQL"],
  },
  {
    term: "Hibernate",
    reading: "ハイバネート",
    category: "framework",
    description: "JPA仕様の最も広く使われるORM実装。1次/2次キャッシュ、遅延読み込み、HQL、Criteria APIなどの機能を提供する。Spring Data JPAのデフォルト実装。",
    related: ["JPA", "ORM", "Spring Data JPA"],
  },
  {
    term: "Kotlin",
    reading: "コトリン",
    category: "framework",
    description: "JetBrains開発のJVM言語。Null安全、データクラス、コルーチン、拡張関数など、Javaより簡潔なコードが書ける。Javaと100%互換性があり、Android公式言語。",
    related: ["JVM", "コルーチン", "Null安全"],
  },
  {
    term: "コルーチン",
    reading: "コルーチン",
    category: "framework",
    description: "Kotlinの軽量な非同期処理機構。suspend関数で一時停止可能な処理を記述し、launch/asyncで起動する。スレッドより軽量で構造化並行性を提供する。",
    related: ["Kotlin", "suspend", "Flow"],
  },
  {
    term: "Ktor",
    reading: "ケイター",
    category: "framework",
    description: "JetBrains開発のKotlin製Webフレームワーク。コルーチンベースで軽量、プラグインアーキテクチャにより必要な機能だけを組み込める。サーバーとクライアントの両方の機能を提供する。",
    related: ["Kotlin", "コルーチン", "Spring Boot"],
  },
  ...
  // ===== DevOps・インフラ =====
  {
    ...
    reading: "ドッカー",
    category: "devops",
    description: "コンテナ型仮想化プラットフォーム。Dockerfileでイメージを定義し、どの環境でも同じ動作を保証する。Javaアプリのマルチステージビルドで軽量イメージを作成できる。",
    related: ["コンテナ", "Dockerfile", "Docker Compose"],
  },
  {
    term: "CI/CD",
    reading: "シーアイシーディー",
    category: "devops",
    description: "CI（継続的インテグレーション）はコード変更を頻繁に統合しテストを自動実行する手法。CD（継続的デリバリー/デプロイ）はリリースを自動化する手法。GitHub ActionsやJenkinsで実現する。",
    related: ["GitHub Actions", "Jenkins", "テスト自動化"],
  },
  {
    term: "GitHub Actions",
    reading: "ギットハブアクションズ",
    category: "devops",
    description: "GitHubに統合されたCI/CDプラットフォーム。YAMLでワークフローを定義し、push/PRなどのイベントをトリガーにビルド・テスト・デプロイを自動化する。",
    related: ["CI/CD", "Jenkins", "YAML"],
  },
  {
    term: "Jenkins",
    reading: "ジェンキンス",
    category: "devops",
    description: "オープンソースの自動化サーバー。Jenkinsfileでパイプラインを定義し、ビルド・テスト・デプロイを自動化する。プラグインによる高い拡張性が特徴。",
    related: ["CI/CD", "GitHub Actions", "パイプライン"],
  },
  {
    term: "マイクロサービス",
    reading: "マイクロサービス",
    category: "devops",
    description: "アプリケーションを小さな独立したサービスに分割するアーキテクチャ。各サービスは独立してデプロイ・スケーリング可能。API Gateway、サーキットブレーカー、サービスディスカバリ等のパターンを併用する。",
    related: ["API Gateway", "Docker", "Spring Cloud"],
  },
  {
    term: "Kubernetes",
    reading: "クーバネティス",
    category: "devops",
    description: "コンテナオーケストレーションプラットフォーム。コンテナのデプロイ、スケーリング、管理を自動化する。Pod、Service、Deployment等のリソースで構成される。K8sとも略される。",
    related: ["Docker", "コンテナ", "Pod"],
  },
  ...
  // ===== データベース =====
  {
    ...
    reading: "エスキューエル",
    category: "database",
    description: "Structured Query Languageの略。リレーショナルデータベースの操作に使用する標準言語。DDL（定義）、DML（操作）、DCL（制御）に分類される。",
    related: ["DDL", "DML", "JDBC"],
  },
  {
    term: "JOIN",
    reading: "ジョイン",
    category: "database",
    description: "複数のテーブルを結合するSQL操作。INNER JOIN（内部結合）、LEFT JOIN（左外部結合）、RIGHT JOIN（右外部結合）、CROSS JOIN（直積）などがある。",
    related: ["SQL", "サブクエリ", "インデックス"],
  },
  {
    term: "トランザクション",
    reading: "トランザクション",
    category: "database",
    description: "データベース操作の論理的な単位。ACID特性（原子性、一貫性、分離性、永続性）を満たす。BEGIN/COMMIT/ROLLBACKで制御する。",
    related: ["ACID", "分離レベル", "デッドロック"],
  },
  {
    term: "インデックス",
    reading: "インデックス",
    category: "database",
    description: "データベースの検索を高速化するデータ構造。B-Tree、Hash、GINなどの種類がある。WHERE句やJOIN条件のカラムに作成する。書き込みのオーバーヘッドとのトレードオフがある。",
    related: ["SQL", "B-Tree", "EXPLAIN"],
  },
  {
    term: "ウィンドウ関数",
    reading: "ウィンドウかんすう",
    category: "database",
    description: "行のグループ（ウィンドウ）に対して集計を行うSQL関数。GROUP BYと異なり、元の行を保持したまま集計結果を付加できる。ROW_NUMBER、RANK、LAG、LEAD等がある。",
    related: ["SQL", "PARTITION BY", "ORDER BY"],
  },
  {
    term: "JDBC",
    reading: "ジェイディービーシー",
    category: "database",
    description: "Java Database Connectivityの略。JavaからRDBMSに接続するための標準API。DriverManager、Connection、PreparedStatement、ResultSetが主要クラス。SQLインジェクション対策にはPreparedStatementを使用する。",
    related: ["SQL", "PreparedStatement", "JPA"],
  },
];
