...
System.out.println(s.replace('l', 'L'));`,
  ...
  {
    id: "mos-113",
    question: "Excelでシート見出しの色を変更する方法はどれですか？",
    choices: [
      { label: "A", text: "シート見出しを右クリック→「シート見出しの色」で色を選択" },
      { label: "B", text: "「ページレイアウト」タブ→「シートの色」を選択" },
      { label: "C", text: "「ホーム」タブ→「塗りつぶしの色」でシートタブの色を変更" },
      { label: "D", text: "シート見出しの色は変更できない" },
    ],
    correctLabel: "A",
    explanation:
      "シート見出しを右クリック→「シート見出しの色」で好きな色を設定できます。複数のシートを分類・整理する際に便利です。色を解除する場合は同じメニューから「色なし」を選択します。",
    category: "mos",
    difficulty: "beginner",
  },
  {
    id: "mos-114",
    question: "Excelでシートを別のブックにコピーする方法はどれですか？",
    choices: [
      { label: "A", text: "シート見出しを右クリック→「移動またはコピー」→コピー先ブックを選択し「コピーを作成する」にチェック" },
      { label: "B", text: "シートの内容をCtrl+Aで全選択してコピーし、新しいブックに貼り付ける" },
      { label: "C", text: "「ファイル」→「名前を付けて保存」でシートのみ保存" },
      { label: "D", text: "シートを別ブックにコピーする機能はない" },
    ],
    correctLabel: "A",
    explanation:
      "シート見出しを右クリック→「移動またはコピー」で「移動先ブック名」のドロップダウンからコピー先を選択し、「コピーを作成する」にチェックを入れてOKをクリックします。チェックを入れないと移動になります。同一ブック内のコピーも同じ操作で可能です。",
    category: "mos",
    difficulty: "intermediate",
  },
  {
    id: "mos-115",
    question: "Excelでシート名を変更する最も簡単な方法はどれですか？",
    choices: [
      { label: "A", text: "シート見出しをダブルクリックして名前を入力する" },
      { label: "B", text: "「ファイル」→「プロパティ」でシート名を変更する" },
      { label: "C", text: "「ホーム」タブ→「シート名の変更」をクリックする" },
      { label: "D", text: "F3キーを押してシート名を入力する" },
    ],
    correctLabel: "A",
    explanation:
      "シート見出しをダブルクリックすると名前が編集可能になり、新しい名前を入力してEnterで確定します。シート見出しを右クリック→「名前の変更」からも変更できます。シート名には / \\ * ? [ ] : の特殊文字は使用できません。",
    category: "mos",
    difficulty: "beginner",
  },
  {
    id: "mos-116",
    question: "Excelで列の幅をデータの内容に合わせて自動調整する方法はどれですか？",
    choices: [
      { label: "A", text: "列番号の右側の境界をダブルクリックする" },
      { label: "B", text: "列番号をクリックしてDeleteキーを押す" },
      { label: "C", text: "「表示」タブ→「列幅の自動調整」をクリック" },
      { label: "D", text: "列の幅は手動でしか変更できない" },
    ],
    correctLabel: "A",
    explanation:
      "列番号の右側の境界線をダブルクリックすると、その列のデータに合わせて幅が自動調整されます。複数列を選択してからダブルクリックすると一括で調整できます。「ホーム」タブ→「書式」→「列の幅の自動調整」からも実行可能です。行の高さも同様に行番号の下の境界線をダブルクリックで自動調整できます。",
    category: "mos",
    difficulty: "beginner",
  },
  {
    id: "mos-117",
    question: "Excelで行の高さを数値で指定する方法はどれですか？",
    choices: [
      { label: "A", text: "行番号を右クリック→「行の高さ」で数値を入力" },
      { label: "B", text: "「データ」タブ→「行の高さ」で設定" },
      { label: "C", text: "行番号をダブルクリックして数値を入力" },
      { label: "D", text: "「挿入」タブ→「行の設定」から変更" },
    ],
    correctLabel: "A",
    explanation:
      "行番号を右クリック→「行の高さ」で正確な数値を入力できます。「ホーム」タブ→「書式」→「行の高さ」からも設定可能です。行番号の下の境界をドラッグで感覚的に調整することもできます。既定の行の高さは使用フォントによって決まります。",
    category: "mos",
    difficulty: "beginner",
  },
  {
    id: "mos-118",
    question: "Excelのクイックアクセスツールバーの説明として正しいものはどれですか？",
    choices: [
      { label: "A", text: "よく使うコマンドを登録し、ワンクリックで実行できるツールバー" },
      { label: "B", text: "検索と置換を素早く行うためのツールバー" },
      { label: "C", text: "グラフを素早く作成するためのツールバー" },
      { label: "D", text: "マクロを実行するための専用ツールバー" },
    ],
    correctLabel: "A",
    explanation:
      "クイックアクセスツールバーはタイトルバー付近に表示され、よく使うコマンドを自由に追加/削除できます。リボンのコマンドを右クリック→「クイックアクセスツールバーに追加」で登録できます。既定では「自動保存」「上書き保存」「元に戻す」「やり直し」が登録されています。",
    category: "mos",
    difficulty: "beginner",
  },
  {
    id: "mos-119",
    question: "Excelで行を挿入する方法として正しいものはどれですか？",
    choices: [
      { label: "A", text: "挿入したい位置の行番号を右クリック→「挿入」" },
      { label: "B", text: "「ファイル」→「挿入」→「行」を選択" },
      { label: "C", text: "行番号をダブルクリックして「挿入」を選択" },
      { label: "D", text: "Ctrl+R で行を挿入" },
    ],
    correctLabel: "A",
    explanation:
      "挿入したい位置の行番号を選択して右クリック→「挿入」で、選択した行の上に新しい行が挿入されます。複数行を選択してから「挿入」すると、選択した行数分だけ挿入されます。「ホーム」タブ→「挿入」→「シートの行を挿入」からも操作可能です。ショートカットは Ctrl+Shift+「+」です。",
    category: "mos",
    difficulty: "beginner",
  },
  {
    id: "mos-120",
    question: "Excelでセルを削除する際、「上方向にシフト」を選択するとどうなりますか？",
    choices: [
      { label: "A", text: "削除したセルの下にあるセルが上に移動して空いたスペースを埋める" },
      { label: "B", text: "削除したセルの上にあるセルが下に移動する" },
      { label: "C", text: "行全体が削除される" },
      { label: "D", text: "セルの内容だけがクリアされる" },
    ],
    correctLabel: "A",
    explanation:
      "セルの削除（右クリック→「削除」）では、周囲のセルの移動方向を選択します。「上方向にシフト」は下のセルが上に移動、「左方向にシフト」は右のセルが左に移動します。「行全体」「列全体」で行/列ごと削除も可能です。Deleteキーはセルの内容のみクリアし、セル自体は削除しません。",
    category: "mos",
    difficulty: "intermediate",
  },
  {
    id: "mos-121",
    question: "Excelの「コメント」と「メモ」の違いとして正しいものはどれですか？",
    choices: [
      { label: "A", text: "コメントはスレッド形式で返信が可能、メモは従来の吹き出し形式で返信不可" },
      { label: "B", text: "コメントとメモは名前が違うだけで同じ機能" },
      { label: "C", text: "コメントはセルに付けるもの、メモはシートに付けるもの" },
      { label: "D", text: "コメントは印刷でき、メモは印刷できない" },
    ],
    correctLabel: "A",
    explanation:
      "Excel 365では「コメント」はスレッド形式で、他のユーザーが返信でき共同作業に適しています。「メモ」（旧バージョンの「コメント」）はセルに吹き出し形式で注釈を付ける機能で返信はできません。「校閲」タブからそれぞれ追加できます。メモの挿入ショートカットはShift+F2です。",
    category: "mos",
    difficulty: "intermediate",
  },
  {
    id: "mos-122",
    question: "Excelでシートを削除する際の注意点として正しいものはどれですか？",
    choices: [
      { label: "A", text: "シートの削除は「元に戻す」（Ctrl+Z）で取り消せないため注意が必要" },
      { label: "B", text: "シートを削除してもCtrl+Zで元に戻せる" },
      { label: "C", text: "データが入っているシートは削除できない" },
      { label: "D", text: "最後の1枚のシートも削除できる" },
    ],
    correctLabel: "A",
    explanation:
      "シートの削除は元に戻す操作（Ctrl+Z）では取り消せません。データが入っているシートを削除しようとすると確認メッセージが表示されます。また、ブックには最低1枚のシートが必要なため、最後の1枚は削除できません。誤って削除しないよう十分注意してください。",
    category: "mos",
    difficulty: "intermediate",
  },
  {
    id: "mos-123",
    question: "Excelの「形式を選択して貼り付け」で「演算」の「乗算」を選択するとどうなりますか？",
    choices: [
      { label: "A", text: "コピーした値と貼り付け先の既存値が掛け算される" },
      { label: "B", text: "コピーした範囲の値がすべて2倍になる" },
      { label: "C", text: "コピーした値が掛け算の結果に置き換わる" },
      { label: "D", text: "数式内の掛け算部分だけが貼り付けられる" },
    ],
    correctLabel: "A",
    explanation:
      "「形式を選択して貼り付け」（Ctrl+Alt+V）の「演算」セクションでは「加算」「減算」「乗算」「除算」が選択できます。「乗算」を選ぶと、コピーした値と貼り付け先の既存値が掛け算されます。例えば、1.1をコピーして価格一覧に「乗算」で貼り付けると全価格が10%値上げされます。",
    category: "mos",
    difficulty: "intermediate",
  },
  {
    id: "mos-124",
    question: "Excelの「セルのスタイル」の説明として正しいものはどれですか？",
    choices: [
      { label: "A", text: "「ホーム」タブから定義済みの書式セット（タイトル・見出し・合計など）をワンクリックで適用できる" },
      { label: "B", text: "セルのサイズや位置を一括で変更する機能" },
      { label: "C", text: "条件付き書式と同じ機能の別名称" },
      { label: "D", text: "VBAマクロでのみ設定可能な書式" },
    ],
    correctLabel: "A",
    explanation:
      "「ホーム」タブ→「セルのスタイル」で、「タイトル」「見出し1〜4」「合計」「良い/普通/悪い」「注意」「計算」などの定義済みスタイルをワンクリックで適用できます。フォント・塗りつぶし・罫線が一括設定され、ブック全体で統一感のある書式にできます。",
    category: "mos",
    difficulty: "beginner",
  },
  {
    id: "mos-125",
    question: "Excelでシートを切り替えるキーボードショートカットはどれですか？",
    choices: [
      { label: "A", text: "Ctrl+PageDown（次のシート）/ Ctrl+PageUp（前のシート）" },
      { label: "B", text: "Ctrl+Tab / Ctrl+Shift+Tab" },
      { label: "C", text: "Alt+PageDown / Alt+PageUp" },
      { label: "D", text: "Shift+F11 / Ctrl+F11" },
    ],
    correctLabel: "A",
    explanation:
      "Ctrl+PageDown で右のシート（次のシート）に移動し、Ctrl+PageUp で左のシート（前のシート）に移動します。多くのシートがあるブックで効率的に移動できます。Ctrl+Tab はブック間の切り替えに使用します。",
    category: "mos",
    difficulty: "beginner",
  },
  // ============================================================
