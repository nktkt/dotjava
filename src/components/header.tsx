...
const navGroups = [
  {
    ...
    items: [
      ...
      { href: "/jvm", label: "JVM/メモリ" },
      { href: "/exercises", label: "実践演習" },
    ],
  },
  {
    label: "Java実践",
    items: [
      ...
      { href: "/spring-boot-testing", label: "SBテスト" },
      { href: "/security", label: "セキュリティ" },
      { href: "/owasp", label: "OWASP" },
      { href: "/jmeter", label: "JMeter" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/db-design", label: "DB設計" },
      { href: "/postgresql", label: "PostgreSQL" },
      { href: "/redis", label: "Redis" },
      { href: "/messaging", label: "メッセージキュー" },
      { href: "/aws", label: "AWS" },
